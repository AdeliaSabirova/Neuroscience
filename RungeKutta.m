function [f]=RungeKutta(t,dt,f0,const,fun)
% t - integration time
...
f_i=f0;
for i=2:n
    k1=dt*fun(t,f(i-1),const);
    k2=dt*fun(t+dt/2,f(i-1)+k1,const);
    k3=dt*fun(t+dt/2,f(i-1)+k2,const);
    k4=dt*fun(t+dt,f(i-1)+k3,const);
    t_i=t_i+dt;
